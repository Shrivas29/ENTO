...
const SOCIAL = [
  { label: 'LinkedIn', href: 'https://www.linkedin.com/in/shrivas-vm-612540250/', Icon: LinkedInIcon },
  { label: 'Instagram', href: 'https://www.instagram.com/buildwithento/', Icon: InstagramIcon },
]
      ...
      <div className="flex items-center gap-8">
        {SOCIAL.map(({ label, href, Icon }) => (
          <a
            ...
            aria-label={label}
            className="flex items-center gap-2 text-[#F0EDE8]/50 hover:text-[#C8FF57] transition-colors duration-200"
          >
            <Icon />
            <span className="font-body text-[10px] tracking-[0.18em] uppercase">{label}</span>
          </a>
        ))}
      </div>
